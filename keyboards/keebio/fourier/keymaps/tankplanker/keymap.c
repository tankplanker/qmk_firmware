...
#define SPFN1 LT(_FN1, KC_ENTER)
#define BSFN2 LT(_FN2, KC_SPACE)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    KC_GESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,      TD(BCK_CTL),  KC_BSLS,
    ...
    KC_LCTL,  KC_LGUI, KC_LALT,KC_NO,  SPFN1,            BSFN2,                     KC_RALT,TD(LA_CTL), TD(DA_CTL), TD(RA_CTL)
  ),

  [1] = LAYOUT(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,
    RESET,  KC_MINS, KC_EQL, KC_QUOT, KC_SCLN,KC_LBRC, KC_RBRC, KC_4,    KC_5,    KC_6,    KC_QUOT,          KC_TRNS,
    KC_TRNS, KC_TILDE,  KC_AT, KC_HASH, KC_PIPE, KC_CIRCUMFLEX, KC_EQUAL, KC_QUOTE,KC_LBRACKET, KC_RBRACKET,KC_UP,   KC_TRNS,
    KC_TRNS, _______, _______, _______, KC_TRNS,          KC_TRNS,                    KC_0,    KC_LEFT, KC_DOWN, KC_RGHT
  ),

  [2] = LAYOUT(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS,
    _______, _______, _______, KC_INS,  KC_PGUP, KC_HOME, _______, _______, _______, _______, KC_COLN,          KC_TRNS,
    _______, _______, _______, KC_DEL,  KC_PGDN, KC_END,  _______,          _______, _______, _______, _______, KC_TRNS,
