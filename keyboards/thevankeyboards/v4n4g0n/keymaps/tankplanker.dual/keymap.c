...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Qwerty */
    ...
    KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  TD(UA_CTL), KC_RSPC,
    KC_LCTL,KC_LGUI,KC_APP,KC_LALT,  LT(1, KC_ENT),  LT(2, KC_SPC), KC_RALT,TD(LA_CTL), TD(DA_CTL), TD(RA_CTL)
  ),
  [1] = LAYOUT( /* LOWER */
    ...
    LSFT_T(KC_LCBR),KC_TILDE,  KC_AT, KC_HASH, KC_PIPE, KC_CIRCUMFLEX, KC_EQUAL, KC_QUOTE,KC_LBRACKET, KC_RBRACKET,  KC_TRNS,RSFT_T(KC_RCBR),
  ...
  [2] = LAYOUT( /* RAISE */
    ...
    LSFT_T(KC_LABK), KC_EXLM, KC_PERC,KC_BSLASH, KC_AMPR,  KC_AT, KC_CIRCUMFLEX, KC_DQUO,L_CURBR, R_CURBR,TD(PUP_CTL),RSFT_T(KC_RABK),
