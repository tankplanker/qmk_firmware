...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Qwerty */
    ...
    KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  TD(UA_CTL), LT(_RAISE, KC_ENTER),
     KC_LCTL,KC_LGUI,KC_LALT,  KC_NO,   LT(_LOWER, KC_SPC),LT(_LOWER, KC_SPC), KC_RALT,TD(LA_CTL), TD(DA_CTL), TD(RA_CTL)
  ),
  [1] = LAYOUT( /* LOWER */
    WW1, 	 WW2,    WW3,    WW4,    WW5,    WW6,
    RESET,  KC_1, 	  KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_BSLS,
    KC_TRNS,KC_MINS, KC_EQL, KC_QUOT, KC_SCLN, KC_DLR, TD(LA_CTL), TD(DA_CTL), TD(UA_CTL),TD(RA_CTL), KC_TRNS, TD(DEL_CTL),
    LSFT_T(KC_LCBR),KC_TILDE,  KC_AT, KC_HASH, KC_PIPE, KC_CIRCUMFLEX, KC_EQUAL, KC_QUOTE,KC_LBRACKET, KC_RBRACKET,  KC_TRNS,KC_TRNS,
  ...
  [2] = LAYOUT( /* RAISE */
    ...
    RESET,  KC_PLUS, KC_UNDS, KC_BSLS, COLON, KC_TRNS, KC_TRNS,KC_TRNS,  DB_QUOTE,KC_CIRCUMFLEX,   KC_TRNS, KC_ENT,
    LSFT_T(KC_LABK), KC_EXLM, KC_PERC,KC_BSLASH, KC_AMPR,  KC_AT, KC_CIRCUMFLEX, KC_DQUO,L_CURBR, R_CURBR,TD(PUP_CTL),KC_TRNS,
