...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		KC_GESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_NONUS_HASH, KC_SLSH,
		TD(TABCAP), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_QUOT, TD(BCK_CTL), 
		TD(L_SHFT), KC_Z, KC_X, KC_C, KC_V, LT(1, KC_ENT), LT(2, KC_SPC), KC_B, KC_N, KC_M, KC_COMM, ALT_T(KC_DOT), TD(R_SHFT)),

	[1] = LAYOUT(
		KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NUHS,  KC_BSLS,
		KC_TRNS, KC_MINS, KC_EQL, KC_BSLS,  KC_SCLN, KC_QUOT, TD(LA_CTL), TD(DA_CTL), TD(UA_CTL),TD(RA_CTL),  KC_SCLN, TD(DEL_CTL), 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_TRNS),

	[2] = LAYOUT(
		RESET, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_NUBS, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,TD(HOME_CTL), TD(PDWN_CTL), TD(PUP_CTL),TD(END_CTL), KC_INS, KC_TRNS, 
...
void matrix_init_user(void) {
  ...
  //setPinOutput(B6);
 // writePinLow(B6);
   rgblight_set_effect_range(0,40);
...
void keyboard_post_init_user(void) {
 ...
 rgblight_set_effect_range(15,20);
        rgblight_sethsv_noeeprom(255, 255, 65);
     rgblight_setrgb_range(RGB_SPRINGGREEN,0,40); 
  rgblight_set();
